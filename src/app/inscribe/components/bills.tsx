...
export const Bills = (props: Props) => {
    ...
    return (
        <>
        <div className="overflow-x-auto overflow-y-hidden" style={{border: '1px solid rgba(255, 255, 255, 0.20)', borderRadius: 25, maxWidth: 800, margin: '15px auto 0', padding: '10px 0  20px'}}>
